...
<body>
	...
	<hr/>
	<s:form name="form1" action="studAction.action" method="post">
		...
		性	别：<s:radio name="stud.sex" list="#{'男':'男','女':'女'}" listkey="key" listvalue="value"/><br/>
		民	族：<s:select name="stud.nation" list="#request.nationList" listKey="nationid" listValue="nationName" style="width:155px"/><br/>
